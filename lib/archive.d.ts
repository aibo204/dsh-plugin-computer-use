...
type ComputerUseArchiveMode = 'off' | 'high-risk' | 'all-control';
/** Mutable archive policy supplied by the settings namespace. */
interface ComputerUseArchiveSettings {
...
interface ComputerUseArchiveImage {
...
interface ComputerUseArchiveInput {
...
interface ComputerUseArchiveRecord {
  readonly id: string;
...
interface ComputerUseArchiveCleanupResult {
...
declare class ComputerUseArchiveService extends Service {
...
declare class ComputerUseArchiveController extends TypertRemoteService {
...
//#endregion
export { ComputerUseArchiveCleanupResult, ComputerUseArchiveController, ComputerUseArchiveImage, ComputerUseArchiveInput, ComputerUseArchiveMode, ComputerUseArchiveRecord, ComputerUseArchiveService, ComputerUseArchiveSettings };